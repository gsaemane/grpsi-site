...
import { Fuel, Ship, HardHat, CheckCircle2, Waves, Drill, Truck, Factory } from 'lucide-react';
    ...
    const services = [
        {
          ...
          description: "Connecting the archipelago with reliable supply chains.",
          icon: Ship,
          features: [
            "Heavy machinery maritime transport",
            "LC Alcol Landing Craft operations",
            "Inter-island scheduled cargo shipping",
            "Emergency relief logistics coordination",
            "Customs and port clearance support"
          ],
        ...
        },
        {
            ...
            description: "Fuelling industrial growth across the Solomon Islands.",
            icon: Fuel,
            features: [
                "Bulk diesel and petrol supply",
                "High-performance marine lubricants",
                "Industrial fuel storage solutions",
                "Distribution to remote provinces",
                "Aviation fuel logistics (select locations)"
            ],
            image: "/hero_maritime_solomon_islands_1774927638390.png"
        },
        {
            ...
            description: "Building the backbone of modern infrastructure.",
            icon: HardHat,
            features: [
                "Civil engineering design and consultation",
                "Road and bridge construction",
                "Port infrastructure development",
                "Project management for large-scale works",
                ...
                <div key={s.id} className={`max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center ${i % 2 !== 0 ? 'lg:flex-row-reverse' : ''}`}>
                    ...
                    >
                        <div className="w-16 h-16 bg-grpsi-blue rounded-2xl flex items-center justify-center mb-8 shadow-premium">
                            <s.icon className="w-8 h-8 text-grpsi-gold" />
                        </div>
